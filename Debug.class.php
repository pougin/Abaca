...
class Debug {
	...
	static public function show() {
		...
		//页面执行时间
		Debug::fb ( array ('This Page Spend Times ' . self::getTime ().' | Memory Peak '.(memory_get_peak_usage()/1024).' K', self::$time_table ), FirePHP::TABLE );
		//慢页面日志
		...
		//关闭了SERVER变量的显示 by pougin 2011.09.29
		//Debug::fb ( array ('Utility Variables', array (array ('name', 'values' ), array ('GET Variables', $_GET ), array ('POST Variables', $_POST ), array ('Custom Defined Functions', $functions ['user'] ), array ('Include Files', get_included_files () ), array ('Defined Constants', $constants ['user'] ), array ('SERVER Variables', $_SERVER ) ) ), FirePHP::TABLE );
		Debug::fb ( array ('Utility Variables', array (array ('name', 'values' ), array ('GET Variables', $_GET ), array ('POST Variables', $_POST ), array ('Custom Defined Functions', $functions ['user'] ), array ('Include Files', get_included_files () ), array ('Defined Constants', $constants ['user'] ) ) ), FirePHP::TABLE );
	}
	/**
	 * Debug运行日志记录，只记录重要的数据库或者waring fatal等级的错误
	 *
	 */
